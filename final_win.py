...
class FinalWin(QWidget):
    def __init__(self, exp):
        ...
        super().__init__()
        self.exp = exp #получаем данные об эксперименте
    ...
    def initUI(self):
        ...
        self.layout_line.addWidget(self.index_text, alignment= Qt.AlignHCenter)
        self.layout_line.addWidget(self.work_text, alignment= Qt.AlignHCenter)
